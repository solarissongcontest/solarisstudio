...
revoke execute on function televoting.admin_rounds_page_overview(uuid) from public, anon, authenticated;
grant execute on function televoting.admin_rounds_page_overview(uuid) to service_role;
