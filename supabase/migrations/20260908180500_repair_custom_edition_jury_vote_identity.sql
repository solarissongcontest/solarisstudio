...
-- Rebuild uniqueness around the canonical voter/recipient identity. This is an
-- idempotent repair for environments that drifted back to country-only indexes.
