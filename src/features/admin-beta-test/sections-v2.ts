  ...
  return [
    ...
    },
    {
      ...
      questions: [
        ...
        single("delegationLinkClarity", "Was the one-source-of-truth / synchronized-edition relationship understandable?", "delegationEditionLinksTested"),
        tested("delegationSettingsTested", "Delegation settings"),
        single("delegationSettingsClarity", "Were portal access, active edition and response-editing settings understandable?", "delegationSettingsTested"),
    ...
    },
    {
      ...
      task: {
        body: "Open Voting admin. Inspect service readiness and next action, Edition links, Voting rounds, and a round's Entries page. Check the canonical Solaris source, custom entries, order and self-voting controls without changing live voting data unnecessarily.",
      ...
      questions: [
        ...
        single("votingEditionSourceTruth", "Was it clear Solaris owns edition identity and Televoting only keeps linked projections?", "votingEditionLinksTested"),
        ...
        rating("roundEntrySyncClarity", "How clear is the Solaris source/binding vs custom-entry workflow?", "votingRoundEntriesTested", "Opaque", "Very clear"),
    ...
    },
    {
      ...
      questions: [
        ...
        single("reloadContext", "After refresh, did the correct edition/workspace/context survive?", "sessionTested", ["Yes", "Mostly", "No"]),
