...
type LibraryGroup = "Explore" | "Reference" | "Insights" | "Participate" | "Tools" | "MySolaris";
  ...
  head: () => ({
    meta: [
      { title: "Library — Solaris Studio" },
      {
        name: "description",
        content:
          "Search Solaris pages, official rules, interpretations and Trust & Integrity help.",
      },
    ],
  }),
...
const LIBRARY_DESTINATIONS: LibraryDestination[] = [
  ...
  },
  {
    to: "/countries",
    title: "Countries",
    description: "Countries, entries and results",
    group: "Explore",
    icon: Compass,
  ...
  },
  {
    to: "/shows",
    title: "Shows",
    description: "Semi-finals, finals and line-ups",
    group: "Explore",
    icon: Sparkles,
  ...
  },
  {
    to: "/wiki",
    title: "Wiki",
    description: "Country and contest pages",
    group: "Explore",
    icon: BookOpen,
...

  {
    to: "/rules",
    title: "Rulebook",
    description: "Official SSC regulations",
    group: "Reference",
    icon: BookOpen,
    keywords: ["rules", "rulebook", "regulations", "official rules"],
  },
  {
    to: "/rules/interpretations",
    title: "Interpretations",
    description: "Official rule clarifications",
    group: "Reference",
    icon: BadgeCheck,
    keywords: ["interpretation", "clarification", "rule guidance"],
  },
  {
    to: "/rules/changes",
    title: "Rulebook history",
    description: "Published rule changes",
    group: "Reference",
    icon: FileClock,
    keywords: ["rule changes", "history", "release", "governance"],
  },
  {
    to: "/integrity",
    title: "Trust & Integrity",
    description: "Reports, cases and appeals",
    group: "Reference",
    icon: ShieldCheck,
    keywords: ["integrity", "report", "anonymous", "appeal", "case", "help"],
  },

  {
    to: "/results",
    title: "Results",
    description: "Rankings and scorecharts",
    group: "Insights",
    icon: Trophy,
  ...
  },
  {
    to: "/analysis",
    title: "Analysis",
    description: "Voting patterns and statistics",
    group: "Insights",
    icon: BarChart3,
  ...
  },
  {
    to: "/relationships",
    title: "Relationships",
    description: "Voting similarities",
    group: "Insights",
    icon: BarChart3,
  ...
  },
  {
    to: "/records",
    title: "Records",
    description: "All-time records and milestones",
    group: "Insights",
    icon: Trophy,
...

  {
    to: "/participate",
    title: "Participate",
    description: "Voting and submissions",
    group: "Participate",
    icon: Vote,
  ...
  },
  {
    to: "/confirmations",
    title: "Confirmations",
    description: "Submit or edit a confirmation",
    group: "Participate",
    icon: Vote,
  ...
  },
  {
    to: "/jury-voting",
    title: "Jury voting",
    description: "Submit jury points",
    group: "Participate",
    icon: Vote,
...

  {
    to: "/tools",
    title: "Tools",
    description: "Interactive Solaris tools",
    group: "Tools",
    icon: Wrench,
  ...
  },
  {
    to: "/predictions",
    title: "Predictions",
    description: "Build and track predictions",
    group: "Tools",
    icon: Sparkles,
...

  {
    to: "/my-solaris",
    title: "MySolaris",
    description: "Personal activity and participation",
    group: "MySolaris",
    icon: UserRound,
  ...
  },
  {
    ...
    description: "Country, entries and page tools",
    group: "MySolaris",
    icon: UserRound,
...
function LibraryPage() {
  ...
  const governanceResults = searchGovernanceLibrary(
    query,
      ...
      <div className="mx-auto max-w-5xl pb-20">
        ...
        <section className="mt-4 rounded-2xl border border-white/[0.08] bg-white/[0.02] p-3 sm:p-4">
          <PublicSearchField
            ...
            ariaLabel="Search Solaris Library"
          />
        </section>

        <section
          className="mt-4 rounded-[1.6rem] border border-white/[0.08] bg-white/[0.02] p-4 sm:p-5"
          aria-label="Solaris Library"
        >
          <div className="mb-4 flex items-end justify-between gap-3">
            <div>
              <p className="text-[9px] font-black uppercase tracking-[0.16em] text-muted-foreground/65">
                Solaris Library
              </p>
          ...
          {destinationResults.length ? (
            <div className="space-y-5">
              {GROUP_ORDER.map((group) => {
                const items = destinationResults.filter(
                  (destination) => destination.group === group,
                );
                if (!items.length) return null;
                return (
                  <div key={group}>
                    <p className="mb-1.5 px-1 text-[9px] font-black uppercase tracking-[0.15em] text-muted-foreground/65">
                      {group}
                    </p>
          ...
          {!hasResults && searching ? (
            <div className="rounded-xl border border-dashed border-white/[0.08] px-4 py-6 text-center">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Try a shorter term or a rule number.
              </p>
            </div>
          ) : null}
          ...
          {interpretations.isError || releases.isError ? (
            <p className="mt-4 border-t border-white/[0.07] pt-3 text-[10px] leading-4 text-muted-foreground">
              Some rule history is temporarily unavailable. Current rules and other Library pages
              still work.
            </p>
          ) : null}
        </section>
...
function DestinationRow({ destination }: { destination: LibraryDestination }) {
  ...
  return (
    ...
    >
      <span
        className={cn(
          "grid size-9 shrink-0 place-items-center rounded-lg border border-white/[0.07] bg-white/[0.025] text-sky-100",
        )}
      >
