...
function RelationshipPairPage() {
  ...
  return (
    <AppShell>
      <PageHeader
        eyebrow={`${shared.length} shared edition${
          shared.length ===
          1
            ? ""
            : "s"
      ...
      <Panel className="mb-5">
        <div className="grid grid-cols-2 gap-x-5 gap-y-5 sm:grid-cols-4">
          <StatTile
            ...
            value={
              relationship.participationsTogether
            }
          />
          ...
          <StatTile
            label="Rivalry"
            value={
              relationship.rivalryScore.toFixed(
                0,
              )
            }
          />
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        <Panel
          ...
          description="Ordered by SSC edition number."
        >
          {chartData.length ? (
