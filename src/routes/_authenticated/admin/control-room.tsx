...
export const Route =
  createFileRoute(
    "/_authenticated/admin/control-room",
  )({
    head: () => ({
      meta: [
        {
          title:
            "Control Room — Solaris Studio",
        },
      ],
    }),
...
> = {
  ...
  warning:
    "border-sky-400/20 bg-sky-400/7 text-sky-100",

  complete:
    "border-emerald-400/20 bg-emerald-400/7 text-emerald-100",
};
  ...
  return (
    <AppShell>
      <PageHeader
        ...
        description="What changed, what is incomplete, and what should happen next."
        actions={
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="min-w-[220px]">
            <div className="flex items-end justify-between">
              ...
              <span className="numeric text-3xl font-black">
                {
                  readiness.progress
                }
                %
      ...
      <div className="grid min-w-0 gap-4 xl:grid-cols-[1.45fr_.8fr]">
        <div className="space-y-4">
          <Panel
            ...
            description="Live checks derived from the actual edition data."
          >
            {!readiness
              .issues
              .length ? (
          ...
          <Panel
            ...
            description="Green means Solaris found no current blocker or warning in that area."
          >
                  ...
                  >
                    ...
                    <p className="mt-2 text-[11px] opacity-70">
                      ...
                      "complete"
                        ...
                        : "Open Action Centre for the exact items."}
                    </p>
                  </div>
                ),
              )}
          ...
          <Panel
            ...
            description="Audit history from organizer and country-data changes."
          >
            {(
              audit ?? []
            ).length ? (
        ...
        <div className="space-y-4">
          <Panel
            title="Next action"
            description="The highest-priority thing Solaris thinks should happen next."
          >
            {nextIssue ? (
              <IssueRow
                issue={
          ...
          <Panel
            title="Deadlines"
            description="Operational deadlines for the current edition."
          >
            {upcoming ? (
          ...
          <Panel title="Notifications">
            <div className="flex items-end justify-between">
              <div>
                <p className="numeric text-4xl font-black">
                  {
                    unread.length
                  }
                </p>
            ...
            <Link
              to="/admin/action-centre"
              className="mt-4 inline-flex text-xs font-bold text-primary"
            >
              Open Action
              Centre →
            </Link>
          ...
          <Panel title="Quick actions">
            <div className="grid gap-2">
              <Link
                ...
                className="rounded-xl border border-border bg-surface px-3 py-3 text-sm font-semibold"
              >
                Open{" "}
                {editionLabel(
                  current,
...
function IssueRow({
  ...
  return (
    <div
      className={cn(
        "flex min-w-0 gap-3 rounded-xl border p-3.5",
        severityStyle[
          issue.severity
        ],
        emphasis &&
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <Link
          ...
          className="mt-2 inline-flex text-[10px] font-black uppercase tracking-[0.1em] underline decoration-current/30 underline-offset-4"
        >
          Fix this →
        </Link>
      </div>
