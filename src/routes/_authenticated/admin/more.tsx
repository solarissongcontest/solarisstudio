...
const groups = [
  {
    ...
    items: [
      ...
      { label: "Country accounts", description: "Choose who can sign in for each country.", to: "/admin/country-accounts", icon: Users },
      { label: "Hosting", description: "Set host countries, host cities and other hosting details.", to: "/admin/hosts", icon: Flag },
      { label: "Country manager history", description: "See who managed each country in past editions.", to: "/admin/hod-history", icon: History },
    ],
  },
  {
  ...
  },
  {
    title: "Testing",
    items: [
      { label: "Organizer test", description: "Run through the main organizer tasks and record what worked.", to: "/admin/beta-test", icon: ClipboardCheck },
      { label: "Organizer test results", description: "Compare recent organizer tests, missing checks and reported bugs.", to: "/admin/admin-beta-feedback", icon: BarChart3 },
    ],
  },
  {
    title: "System",
    items: [
      ...
      { label: "System check", description: "Check whether editions, confirmations and televoting are working together.", to: "/admin/sync-health", icon: Settings },
    ],
  },
] as const;
...
function MoreAdmin() {
  return (
    <div className="mx-auto max-w-3xl">
      <AdminPageHeader
        eyebrow="Organizer pages"
        title="More"
        description="Pages you use less often are kept here. Choose what you want to manage."
      />
