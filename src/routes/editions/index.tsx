    ...
    <AppShell>
      ...
      {archive.length > 0 && (
        <section className="mt-6 sm:mt-8">
          <div className="mb-3 flex items-end justify-between gap-4 border-b border-border/60 pb-3">
...
function LatestEdition({ card }: { card: EditionCard }) {
  ...
  return (
    <section>
      ...
      >
        <div className="relative min-h-[270px] overflow-hidden sm:min-h-[390px]">
          <BackgroundFlag
          ...
          <div className="relative z-10 flex min-h-[270px] flex-col justify-between p-4 sm:min-h-[390px] sm:p-7 lg:p-9">
            ...
            <div className="max-w-[760px]">
              ...
              <h2 className="display-headline mt-2 text-4xl leading-[0.92] text-white sm:text-6xl">
              ...
              <div className="mt-5 flex flex-wrap items-center gap-2.5 sm:mt-6 sm:gap-3">
                ...
                {winner && (
                  <div className="flex min-w-0 items-center gap-2 rounded-lg border border-white/12 bg-black/20 px-3 py-2 backdrop-blur-md">
                    <FlagChip
      ...
      <div className="relative z-10 min-w-0">
        <div className="flex min-w-0 items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            ...
            <h3 className="mt-1 truncate text-[1.25rem] font-bold leading-tight tracking-[-0.035em] text-foreground sm:text-[1.4rem]">
              {editionLabel(edition)}
            </h3>
