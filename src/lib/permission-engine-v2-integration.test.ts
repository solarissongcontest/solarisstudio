...
describe("Permission Engine v2 administration", () => {
  ...
  it("shows authoritative enforcement while retaining telemetry review", () => {
    ...
    expect(readiness).toContain("Authoritative enforcement active");
    expect(readiness).toContain("Review telemetry");
    expect(readiness).toContain("Advanced · current model");
  });
