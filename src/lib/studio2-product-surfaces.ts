...
export const STUDIO2_PRODUCT_SURFACES: Readonly<Record<SolarisFeatureFlag, Studio2ProductSurface>> = {
  ...
  workflow_engine: {
    ...
    description: 'Organizer workflow operations derived from canonical contest state and evaluated by the shared Workflow Engine.',
  },
  ...
  incident_command: {
    ...
    description: 'Dedicated incident command surface for triage, acknowledgement, command, timeline, crisis, resolution and postmortem work.',
  },
  broadcast_rundown: {
