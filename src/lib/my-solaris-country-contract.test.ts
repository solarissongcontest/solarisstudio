...
const appearance = source("src/features/my-solaris/theme/MySolarisThemePage.tsx");
const builder = source("src/features/my-solaris/page-builder/MySolarisPageBuilderPage.tsx");
