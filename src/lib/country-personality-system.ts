...
export const COUNTRY_PERSONALITIES = [
  {
    ...
    referenceFamily: "Apple Liquid Glass",
    implementationReference: "Apple WWDC25 Liquid Glass composition principles; CSS backdrop-filter used only for the functional floating layer.",
  ...
  },
  {
    ...
    referenceFamily: "Financial Times Origami + Guardian Source",
    implementationReference: "Responsive editorial grid, restrained rules, serif/sans hierarchy and caption logic adapted to Solaris country identity.",
  ...
  },
  {
    ...
    referenceFamily: "ICAO Doc 9303 document zoning",
    implementationReference: "Header, identity, document-field and seal zones adapted from machine-readable travel document information architecture.",
  ...
  },
  {
    ...
    wikiStyle: "modern",
    layout: "poster-grid",
    referenceFamily: "International Typographic Style / Swiss poster design",
    implementationReference: "Asymmetric modular grid, sans-serif display type, controlled colour block and index typography.",
  ...
  },
  {
    ...
    implementationReference: "Archive-style hierarchy, responsive grid, formal metadata and minimal rules adapted to a national profile.",
  ...
  },
  {
    ...
    referenceFamily: "Geist / modern neutral product typography",
    implementationReference: "Coordinated type scale, strict whitespace and no decorative surface treatment.",
  ...
  },
  {
    ...
    wikiStyle: "editorial",
    layout: "atlas-grid",
    referenceFamily: "Mapbox cartographic layer systems",
    implementationReference: "Ordered cartographic visual layers, coordinate labels, contour language and a dedicated map-art cell.",
  ...
  },
  {
    ...
    referenceFamily: "GOV.UK + USWDS + UN web guidelines",
    implementationReference: "Human-centred public-service grid, clear labels, strong text hierarchy and minimal official ornament.",
  ...
  },
  {
    ...
    referenceFamily: "Human-built event systems + Swiss poster discipline",
    implementationReference: "Accessible event branding, responsive colour fields and a contained rhythm-art cell rather than stage-light effects.",
  ...
  },
  {
    ...
    referenceFamily: "IBM 2x Grid + post-Swiss graphic systems",
    implementationReference: "Modular hard cells, square corners, strong borders and strict alignment; rough finish without broken usability.",
  ...
  },
  {
    ...
    wikiStyle: "modern",
    layout: "retro-window",
    referenceFamily: "98.css / XP.css semantic retro UI",
    implementationReference: "Faithful semantic window treatment, 1px borders, status rows and system-like metadata without futuristic HUD tropes.",
  ...
  },
  {
    ...
    referenceFamily: "High-fashion editorial art direction",
    implementationReference: "Asymmetric editorial spacing, hairline details, prominent clean imagery and minimal interface chrome.",
  ...
  },
  {
    ...
    referenceFamily: "Guardian Source + FT Origami",
    implementationReference: "Responsive newsroom grid, serif headline, sans metadata, dateline and double-rule masthead logic.",
  ...
  },
  {
    ...
    referenceFamily: "IBM Carbon + NASA web typography",
    implementationReference: "Data-first grid, tabular numerals, reference IDs, readable lead/body measures and contained measurement marks.",
  ...
  },
  {
    ...
    wikiStyle: "modern",
    layout: "civic-grid",
    referenceFamily: "USWDS + GOV.UK public-service design",
    implementationReference: "Clear mobile-first hierarchy, strong accessible actions, practical spacing and prominent but undistorted flag media.",
  ...
  },
  {
    ...
    referenceFamily: "Wim Crouwel + Bruno Monguzzi post-Swiss systems",
    implementationReference: "Experimental scale and off-axis alignment contained by a modular grid; one unexpected art cell, never content collision.",
