 ...
 *
 * This deliberately hides the old developer-level editor.
 *
 * Organisers should normally only need:
 *  - starting style
 *  - background
 *  - country-card look
 *  - visible information
 *  - title
 *
 * The underlying ScoreboardConfig remains powerful, so old saved
 * configurations and presets still work. We simply stop forcing humans
 * to operate every internal switch to change a background picture.
 */
export function ScoreboardEditor({
    ...
    (
      ...
      set({
        background: {
          ...
          /*
           * Decorative patterns were the diagonal/grid lines showing up
           * unexpectedly in previews. The simple editor does not expose
           * them, so they are always disabled here.
           */
          pattern:
            "none",
  ...
  const applyPreset =
    (
      ...
      /*
       * Keep production-only settings untouched.
       */
      preset.music =
        config.music;
      ...
      /*
       * Always remove pattern overlays in the simplified editor.
       */
      preset.background = {
        ...preset.background,
    ...
    <div className="space-y-4">
      ...
      >
        ...
        {backgroundChoice ===
          ...
          <div className="mt-4 space-y-3">
            <Field
              ...
              hint="Paste the direct public URL of the image."
            >
              <TextInput
                value={
                  config.background
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          <Field
            label="Darkness"
            hint="Dark overlay on top of the background."
          >
            <Slider
              min={0}
              max={0.8}
          ...
          <Field
            label="Soft blur"
            hint="Blur the background slightly, not the country cards."
          >
            <Slider
              min={0}
              max={18}
      ...
      <details className="rounded-2xl border border-border bg-surface/35">
        <summary className="cursor-pointer list-none p-4">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Only open this if something actually needs adjusting.
          </p>
        </summary>
