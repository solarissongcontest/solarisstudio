  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-2xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:duration-[240ms] data-[state=closed]:duration-200 [animation-timing-function:cubic-bezier(0.32,0.72,0,1)]",
  {
    variants: {
      side: {
        ...
        responsive:
          "inset-x-0 bottom-0 max-h-[92dvh] rounded-t-[1.4rem] border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom sm:inset-x-auto sm:inset-y-0 sm:right-0 sm:bottom-auto sm:h-full sm:max-h-none sm:w-[min(31rem,52vw)] sm:rounded-none sm:border-l sm:border-t-0 sm:data-[state=closed]:slide-out-to-right sm:data-[state=open]:slide-in-from-right",
      },
    },
    defaultVariants: {
      side: "right",
...
>(({ side = "right", className, children, showCloseButton = true, ...props }, ref) => {
  const accessibleTitle = props["aria-label"];
